...
export const SCENES: Scene[] = [
  {
    ...
    index: '01',
    kicker: 'Immersive',
    title: 'Light that bends around you.',
    body: 'Real-time WebGL — a living field of contour and light, drawn on the GPU and flowing around your cursor as you move it.',
