      ...
      <div className="container-px mx-auto max-w-[1200px]">
        ...
        >
          <p className="max-w-xs text-[14px] leading-relaxed text-mist-500">
            <span className="text-mist-300">We’ve also shipped.</span> Quietly — the proof is the work,
            not the showcase.
          </p>
              ...
              w.link ? (
                <li key={w.name}>
                  ...
                  >
                    ...
                    <span className="font-mono text-[11px] text-mist-700 group-hover:text-amber/70">
                      {w.kind} ↗
                    </span>
                  </a>
                </li>
                ...
                <li key={w.name} className="inline-flex items-baseline gap-2 text-mist-300">
                  <span className="text-[15px]">{w.name}</span>
                  <span className="font-mono text-[11px] text-mist-700">{w.kind}</span>
                </li>
              )
            )}
          </ul>
